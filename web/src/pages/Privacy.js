  ...
  return (
    <div className="main-about-container">
      ...
      <p>
        ...
        accordance with this Privacy Policy. This Privacy Policy has b een
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            controlled by or is under common control with a part{"y"}, w here
        ...
        <li>
          <p>
            ...
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Ou r&quot; in
            this Agreement) refers to Clipboard.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Device</strong> means any dev ice that can access the
        ...
        <li>
          <p>
            <strong>Service</strong> refe rs to the Website.
          </p>
        </li>
        ...
        <li>
          <p>
            ...
            infrastructure itself (for example, the duration of a page v isit).
          </p>
        </li>

        <li>
          <p>
            <strong>Website</strong> refers to Clipboard, accessible from{" "}
            <a
      ...
      <p>
        ...
        personally identifiable information that can be used to cont act or
      ...
      <p>
        Usage Data may include information such as Your Device's Intern et
      ...
      <p>
        When You access the Service by or through a mobile device, We m ay
        collect certain information automatically, including, but not limited
        to, the type of mobile device You use, Your mobile device unique ID, the
        IP address of Your mobile device, Your mobile operating system, the type
        of mobile Internet browser You use, unique device identifiers and oth er
        diagnostic data.
      </p>
      <p>
      ...
      <p>
        We use Cookies and similar tracking technologies to track the activ ity
        on Our Service and store certain information. Tracking technolog ies
      ...
      <ul>
        <li>By email: santosh_pisini@outlook.com</li>
      </ul>
